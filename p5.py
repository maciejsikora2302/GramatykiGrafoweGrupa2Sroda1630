...
def p5(graph: nx.Graph, level: int) -> None:
    ...
    right_side_edges = [
        (1,6), (6,2), (2,3), (3,4), (4,5), (5,1), # boundary edges
        (2,5), (3,5), (6,5), # new interal edges
        (1,7), (5,7), (6,7), # hiperedges of <1,5,6> triangle
        (2,8), (3,8), (5,8), # hiperedges of <2,3,5> triangle
        (3,9), (4,9), (5,9),  # hiperedges of <3,4,5> triangle
        (2,10), (5,10), (6,10)  # hiperedges of <2,5,6> triangle
    ]
